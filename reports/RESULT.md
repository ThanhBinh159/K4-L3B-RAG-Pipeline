...
Cả hai báo cáo dùng metric proxy được mô tả trong từng file. Không diễn giải các điểm này thành xác nhận pháp lý hoặc đánh giá bởi chuyên gia. Chạy lại bằng `python -m src.evaluate` hoặc `python -m src.evaluate_online` theo cấu hình cần đo.
